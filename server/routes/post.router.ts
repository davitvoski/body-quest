...
import { createPost, deleteAllPostByUser, deletePost, getAllPosts, toggleLikedPost } from "../controllers/post.controller";
...
postRouter.delete("/deleteallposts", isAuthenticated, deleteAllPostByUser)
